...
P = impose_default_value(P,'coverage_models_mat_file',       'reference/coverage_models.agilent.mat');
P = impose_default_value(P,'basewise_coverage_fwb_file',     'none');
P = impose_default_value(P,'target_list_file',               'reference/target_list.gencode25.txt');
P = impose_default_value(P,'context_and_effect_fwb_file',    'reference/context_and_effect_track.gencodeV39.fwb');
P = impose_default_value(P,'context_and_effect_categs_file', 'reference/context_and_effect.c65e29b.txt');
P = impose_default_value(P,'covariates_file',                'reference/covariates.agilent.txt');
P = impose_default_value(P,'conservation_fwb_file',          'reference/conservation_phyloP100way_hg38.fwb');
